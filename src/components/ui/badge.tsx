...
interface BadgeProps {
  ...
  variant?: 'default' | 'success' | 'xp' | 'primary' | 'danger'
  className?: string
}
...
export function Badge({ children, variant = 'default', className }: BadgeProps) {
  return (
    <span className={cn(
      ...
      variant === 'xp'      && 'bg-xp/10 text-xp border border-xp/25',
      variant === 'primary' && 'bg-primary/10 text-primary border border-primary/25',
