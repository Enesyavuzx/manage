  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'burst':      'burst 1.6s ease-out infinite',
      },
      keyframes: {
        ...
        snowfall: { '0%': { transform: 'translateY(-12px) translateX(0)', opacity: '0' }, '10%': { opacity: '0.9' }, '100%': { transform: 'translateY(480px) translateX(14px)', opacity: '0.2' } },
        leaffall: { '0%': { transform: 'translateY(-12px) translateX(0) rotate(0deg)', opacity: '0' }, '12%': { opacity: '1' }, '100%': { transform: 'translateY(480px) translateX(40px) rotate(220deg)', opacity: '0.4' } },
        burst:    { '0%': { transform: 'scale(0)', opacity: '1' }, '65%': { opacity: '0.85' }, '100%': { transform: 'scale(1)', opacity: '0' } },
      },
    },
  },
  plugins: [],
